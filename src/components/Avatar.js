            ...
            <div className="avatar__block">
                ...
                <ul className="socials-square d-flex justify-content-between">
                    {contact.map((item, _) => (
                        ...
                        <a className="socials-square__link btn" href={item.link} target="_blank" rel="noreferrer"><i className={item.symbol}></i></a>
                        </li>
                    ))}
                </ul>
                </div>
                <div className="avatar__btnholder">
                <a className="btn btn-default btn-fullwidth btn-hover btn-hover-accent" href="#contact" target="_blank" rel="noreferrer">
                    <span className="btn-caption">Let's Connect!</span>
                </a>
                </div>
            </div>
            </div>
