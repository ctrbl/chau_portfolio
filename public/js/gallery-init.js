...
var initPhotoSwipeFromDOM = function(gallerySelector) {
    ...
    var parseThumbnailElements = function(el) {
        ...
        for(var i = 0; i < numNodes; i++) {
            ...
            if (figureEl.children.length > 1) {
                // <figcaption> content
                var titleHTML = '';
                var children = Array.from(figureEl.children[1].children); // Convert to array for easier manipulation
            
                // Exclude the last child
                var filteredChildren = children.slice(0, -1);
            
                // Reconstruct the title HTML
                filteredChildren.forEach(child => {
                    titleHTML += child.outerHTML;
                });
    ...
    var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
        ...
        pswpElement.setAttribute('data-lenis-prevent', 'true');
